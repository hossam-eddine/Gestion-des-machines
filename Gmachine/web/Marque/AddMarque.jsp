...
<section style="margin-left: 20%; margin-right: 20%; height: 200px; padding-top: 3%; margin-top: 5%;">
    <div class="col" style="text-align: center;">
       <h4 style=" font-family: 'Poppins Medium'; font-weight: bold;text-align: center; ">Add Marque</h4>
    </div>
    <center>
    ...
    <form method="POST" style="margin-top: 7%;" >
            <div class="row">
                <div class="col">
                    <input type="text" class="form-control" name="libelle" placeholder="libelle"  style="margin-top: 3%;">
                </div>
            </div>
            <div class="row">
                <div class="col">
                 
                    <input type="text" class="form-control"  placeholder="code" name="code" style="margin-top: 3%;">
