...
<section style="margin-left: 20%; margin-right: 20%; height: 200px; padding-top: 3%; margin-top: 5%;">
    ...
    <form method="POST" style="margin-top: 7%;" >
            <div class="row">
                <div class="col">
                   <input type="date" class="form-control" name="date1" style="margin-top: 3%;">
                </div>
                <div class="col">
                    <input type="date" class="form-control" name="date2" style="margin-top: 3%;">
                </div>
            </div>
           
           
            <center>
                <input  type="submit" class="btn" name="submit" value="Search" style="background-color: #FE6825; color: white; font-family: 'Poppins Medium'; margin-top: 4%;">
            </center>
        </form>
    </section>
    <div class="container">
        <div class="row row-cols-1 row-cols-md-2" style="margin-top: 6%;">
            <c:if test="${ empty AllMachines}">
                <h1>Choose two dates</h1>
            </c:if>
           <c:if test="${ not  empty AllMachines}">
            <c:forEach var="Truck" items="${AllMachines }">
                <div class="col mb-4">
                    <div class="card">
                        <img src="images/mach.jpg" class="card-img-top"  style="height: 300px"/>
                        <div class="card-body">
                            <h5 class="card-title" style="color: #fe6825;"><c:out value="${Truck.reference}"></c:out></h5>
